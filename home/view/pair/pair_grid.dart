...
import 'pair_solve_screen.dart';

class PairGridScreen extends GetView<PairGridController> {
  @override
  Widget build(BuildContext context) {
    Get.put(PairGridController());
    return GetBuilder<PairGridController>(
        init: PairGridController(),
        builder: (context) {
          return WillPopScope(
              onWillPop: () async {
...
_bodyWidget(PairGridController controller) {
  return Stack(
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Get.to(PairSolveScreen(), arguments: {
...
Widget checkRobot(PairGridController controller) {
  if (!controller.isNumberPuzzleRobotShown) {
    ...
    // controller.box.write('isPairGameRobotShown', true);
