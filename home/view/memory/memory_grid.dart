import 'package:KidsPlan/pages/home/view/memory/memory_solve_screen.dart';
...
class MemoryGridScreen extends GetView<MemoryGridController> {
  @override
  Widget build(BuildContext context) {
    Get.put(MemoryGridController());
    return GetBuilder<MemoryGridController>(
        init: MemoryGridController(),
        builder: (context) {
          return WillPopScope(
              onWillPop: () async {
...
_bodyWidget(MemoryGridController controller) {
  return Stack(
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          // Get.to(MemoryGameSolve(), arguments: {
...
Widget checkRobot(MemoryGridController controller) {
  if (!controller.isNumberPuzzleRobotShown) {
    ...
    // controller.box.write('isMemoryCardGameRobotShown', true);
